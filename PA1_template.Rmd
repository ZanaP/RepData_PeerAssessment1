...
## Project Description:
This was the first peer graded project for the **Reproducible Research** course in Coursera's Data Science specialization track. The purpose of this project was to practice:
...
According to the created plot there is a higher peak earlier on weekdays, and more overall activity present on the weekends in general.
